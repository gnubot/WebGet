...
Rがゼロ以外の終了コードを返した場合は、サーバーが200以外のHTTP応答コードを返した可能性があります。応答コードを確認するには、コンソールを調べてみてください。 200の場合、問題は一般的であり、WebGetに問題があるため、次のURLで報告する必要があります。[ｈっｔｐｓ：／／ぎてゅｂ。こｍ／Ｔｙぇｒ８８７／うぇｂげｔ／いっすえｓ](https://github.com/Tyler887/WebGet/issues)。
